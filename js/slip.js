...
(function(WIN, DOC) {
  ...
  Slip = (function() {
    ...
    /**
     * @param ele 滑屏的容器
     * @param direction 滑动方向 x, y
     * @param dur 滑动时间(ms)
     * @param ease 缓动方式(css的transition)
     * @constructor
       */
    function Slip(ele, direction, dur, ease) {
      this.ele = ele;
    ...
    Slip.prototype.onSliderEnd = function(event, data) {
      ...
      setTransition(ele, "all " + duration + "ms " + this.ease);
      if (isVerticalWebapp) {
